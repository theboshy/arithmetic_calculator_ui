...
export const additionService = async (variables: any): Promise<InternalResponseInterface | null> => {
    let queryParams = "";
    ...
    const baseUrl = `${sources.base_url}${sources.endpoints.addition.name}${queryParams}`
