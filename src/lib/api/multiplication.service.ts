...
export const multiplicationService = async (variables: any): Promise<InternalResponseInterface | null> => {
    let queryParams = "";
    ...
    const baseUrl = `${sources.base_url}${sources.endpoints.multiplication.name}${queryParams}`
